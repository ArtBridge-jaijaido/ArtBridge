        ...
        unsubscribeUserSnapshot = onSnapshot(userRef, (snapshot) => {
          if (snapshot.exists()) {
            ...
            store.dispatch(setUser({
                ...userData,
                createdAt: userData.createdAt?.toDate().toISOString() || null, // 轉換成 ISO 字串
                verificationCodeExpiresAt: userData.verificationCodeExpiresAt?.toDate().toISOString() || null, // 轉換成 ISO 字串
              }));
          } else {
