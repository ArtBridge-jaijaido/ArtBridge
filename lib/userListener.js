...
import { setAllUsers, updateAllUser, addUserToAllUsers } from "@/app/redux/feature/userSlice";
        ...
        if (isInitialLoad) {
            ...
            snapshot.docChanges().forEach((change) => {
                ...
                if (change.type === "added") {
                    store.dispatch(addUserToAllUsers({ userUid, userData: processedUserData }));
                    console.log("➕ 新增用戶:", userUid, processedUserData);
                }

                if (change.type === "modified") {
                    store.dispatch(updateAllUser({ userUid, userData: processedUserData }));
